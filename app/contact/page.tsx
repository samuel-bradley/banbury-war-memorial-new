    ...
    <Main pageName="contact" heading="Contact" content = {
      <>
        ...
        <form action={sendEmail}>
          <div className="border-b border-gray-900/10 pb-6">
            <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
              <div className="sm:col-span-6">
                <p className="max-w-sm">If you have any questions or corrections, please leave a message and we'll try to get back to you soon.</p>
              </div>
              <div className="sm:col-span-6">
          ...
          <button type="submit" className="rounded-md bg-gray-500 px-3 py-2 font-semibold text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Send</button>
        </form>
      </>
    }/>
  )
